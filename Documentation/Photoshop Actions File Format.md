...
Listener](</web/20150907062107/http://www.tonton-pixel.com/blog/json-photoshop-scripting/json-action-toolbox/#json-event-listener>),
part of the [JSON Action
Toolbox](</web/20150907062107/http://www.tonton-pixel.com/blog/json-photoshop-scripting/json-action-toolbox/>),
...
in the module
[jamActions](</web/20150907062107/http://www.tonton-pixel.com/JSON%20Action%20Manager/jsDoc/symbols/jamActions.html>),
which is part of the [JSON Action
Manager](</web/20150907062107/http://www.tonton-pixel.com/blog/json-photoshop-scripting/json-action-manager/>)
scripting library. It is used by three utility scripts:

-   [Convert Actions
    File](</web/20150907062107/http://www.tonton-pixel.com/blog/scripts/utility-scripts/convert-actions-file/>):
...
-   [Parse Actions
    File](</web/20150907062107/http://www.tonton-pixel.com/blog/scripts/utility-scripts/parse-actions-file/>):
    [Photoshop CS2 or later] parse an actions file (.atn) or an actions palette
    file (Actions Palette.psp) into a JSON text file.

-   [Play Actions File
    Action](</web/20150907062107/http://www.tonton-pixel.com/blog/scripts/utility-scripts/play-actions-file-action/>):
